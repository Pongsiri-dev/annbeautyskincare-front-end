        ...
        <Container maxWidth="md" style={flex}>
          <Grid item sm={10} md={12}>
            ...
            <ol>
              ...
              <li>
                <Typography variant="body2">
                ตัวแทนจำหน่ายคนใดกระทำการฝ่าฝืนกฎ ขายตัดราคา ตัวแทนแทนจำหน่ายเหนือขึ้นมาหนึ่งชั้น(ผู้แนะนำ) ต้องรับผิดชอบในการกระทำของลูกทีมตนด้วย ถือได้ว่ากระทำการละเลยให้มีการขายตัดราคา ส่งผลกระทบร้ายแรงต่อระบบตัวแทนจำหน่าย และรวมถึงการดำเนินธุรกิจโดยรวมของบริษัทด้วย ตัวแทนแทนจำหน่ายเหนือขึ้นมาหนึ่งชั้น(ผู้แนะนำ) จะต้องโดนปรับ 300,000 บาท
                </Typography>
              </li>
              <li>
                <Typography variant="body2">
                ตัวแทนจำหน่ายคนใดกระทำการฝ่าฝืนกฎ ขายตัดราคา ตัวแทนแทนจำหน่ายเหนือขึ้นมาสองชั้น ต้องรับผิดชอบในการกระทำของลูกทีมตนด้วย ถือได้ว่ากระทำการละเลยให้มีการขายตัดราคา ส่งผลกระทบร้ายแรงต่อระบบตัวแทนจำหน่าย และรวมถึงการดำเนินธุรกิจโดยรวมของบริษัทด้วย ตัวแทนแทนจำหน่ายเหนือขึ้นมาสองชั้น จะต้องโดนปรับ 100,000 บาท
                </Typography>
              </li>
            </ol>
