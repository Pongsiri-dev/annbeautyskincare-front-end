...
const Policy = Loadable(lazy(() => import("../pages/policy/Index")));
...
const Color = Loadable(
  lazy(() => import("../pages/overview/foundation/FoundationColors"))
);
const Typography = Loadable(
  lazy(() => import("../pages/overview/foundation/FoundationTypography"))
);
const Shadows = Loadable(
  lazy(() => import("../pages/overview/foundation/FoundationShadows"))
);
const Grid = Loadable(
  lazy(() => import("../pages/overview/foundation/FoundationGrid"))
);
const Icons = Loadable(
  lazy(() => import("../pages/overview/foundation/FoundationIcons"))
);
const Accordion = Loadable(
  lazy(() => import("../pages/overview/mui/Accordion"))
);
const Alert = Loadable(lazy(() => import("../pages/overview/mui/Alert")));
const Autocomplete = Loadable(
  lazy(() => import("../pages/overview/mui/Autocomplete"))
);
...
const Breadcrumb = Loadable(
  lazy(() => import("../pages/overview/mui/Breadcrumb"))
);
const Buttons = Loadable(lazy(() => import("../pages/overview/mui/buttons")));
const Checkbox = Loadable(
  lazy(() => import("../pages/overview/mui/Checkboxes"))
);
...
const Pagination = Loadable(
  lazy(() => import("../pages/overview/mui/Pagination"))
);
...
const RadioButtons = Loadable(
  lazy(() => import("../pages/overview/mui/RadioButtons"))
);
...
const Textfield = Loadable(
  lazy(() => import("../pages/overview/mui/textfield"))
);
...
const EditorComponent = Loadable(
  lazy(() => import("../pages/overview/extra/EditorComponent"))
);
const CopyToClipboard = Loadable(
  lazy(() => import("../pages/overview/extra/CopyToClipboard"))
);
const Upload = Loadable(lazy(() => import("../pages/overview/extra/Upload")));
const Carousel = Loadable(
  lazy(() => import("../pages/overview/extra/carousel"))
);
const MultiLanguage = Loadable(
  lazy(() => import("../pages/overview/extra/MultiLanguage"))
);
const Animate = Loadable(lazy(() => import("../pages/overview/extra/animate")));
const MegaMenu = Loadable(
  lazy(() => import("../pages/overview/extra/MegaMenu"))
);
const FormValidation = Loadable(
  lazy(() => import("../pages/overview/extra/form"))
);
const Lightbox = Loadable(
  lazy(() => import("../pages/overview/extra/Lightbox"))
);
const Image = Loadable(
  lazy(() => import("../pages/overview/extra/ImageAspectRatio"))
);
...
const NavigationBar = Loadable(
  lazy(() => import("../pages/overview/extra/NavigationBar"))
);
